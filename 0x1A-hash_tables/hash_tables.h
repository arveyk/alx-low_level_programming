 ...
 *
 * @key: The Key, string
 * The key id unique in the HashTable
 ...
 * Each cell of this array is a pointer to the fist node of a linked list,
 ...
 * @sprey: A pointer to the previous element in the sorted linked list
